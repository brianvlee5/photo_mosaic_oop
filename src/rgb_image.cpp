...
void RGBImage::replaceGrid(int i, int j, vector<Photo_data> &data_vec){
    int sum_r = 0, sum_g = 0, sum_b = 0;
    RGBImage small_img;
    ...
    dir = findGrid(data_vec, sum_r, sum_g, sum_b);
...
string RGBImage::findGrid(vector<Photo_data> &data_vec, int big_r, int big_g, int big_b){
    string small_dir;
